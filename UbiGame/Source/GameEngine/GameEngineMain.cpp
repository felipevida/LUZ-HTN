...
float GameEngineMain::WINDOW_HEIGHT = 1080.f;
float GameEngineMain::WINDOW_WIDTH = 1920.f;
...
float GameEngine::GameEngineMain::getWindowHeight()
{
	return GameEngineMain::WINDOW_HEIGHT;
}

float GameEngine::GameEngineMain::getWindowWidth()
{
	return GameEngineMain::WINDOW_WIDTH;
}
